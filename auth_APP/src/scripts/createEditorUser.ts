...
/**
 * Script to create an editor user (create, read, update) in auth_db
 * This user will have access to secHTTPS_APP with editor role
 * 
 * Usage: ts-node src/scripts/createEditorUser.ts
 */
