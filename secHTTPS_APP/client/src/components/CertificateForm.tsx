...
export const CertificateForm = forwardRef<CertificateFormHandle, CertificateFormProps>(
  ({ initialData, onSubmit, onCancel, isSubmitting = false, submitLabel = 'Guardar' }, ref) => {
    ...
    <form className="certificate-form" ref={formRef} onSubmit={handleSubmit}>
      <div className="form-grid">
        <div className="form-field">
          ...
          <input id="fileName" type="text" value={formData.fileName} onChange={e => handleInputChange('fileName', e.target.value)} />
          {errors.fileName && <span className="error-message">{errors.fileName}</span>}
        </div>
        <div className="form-field">
          <label htmlFor="client">Cliente *</label>
          <input id="client" type="text" value={formData.client} onChange={e => handleInputChange('client', e.target.value)} />
          {errors.client && <span className="error-message">{errors.client}</span>}
        </div>
        <div className="form-field">
          <label htmlFor="server">Servidor *</label>
          <input id="server" type="text" value={formData.server} onChange={e => handleInputChange('server', e.target.value)} />
          {errors.server && <span className="error-message">{errors.server}</span>}
        </div>
        <div className="form-field">
          <label htmlFor="filePath">Ruta del archivo *</label>
          <input id="filePath" type="text" value={formData.filePath} onChange={e => handleInputChange('filePath', e.target.value)} />
          {errors.filePath && <span className="error-message">{errors.filePath}</span>}
        </div>
        <div className="form-field">
          <label htmlFor="configPath">Ruta de configuración *</label>
          <input id="configPath" type="text" value={formData.configPath} onChange={e => handleInputChange('configPath', e.target.value)} />
        ...
        <div className="form-field">
          ...
          <input id="expirationDate" type="date" value={formData.expirationDate} onChange={e => handleInputChange('expirationDate', e.target.value)} />
